...
class CashTransactionHistoryRepository implements ICashTransactionHistoryRepository{
  @override
  Future<Either<ErrorHandler, QrTranscationHistoryModel>> getCashTranscationHistory(String? dateFilterType,String? startDate,String? endDate,String? source,
      String? subAgentId
      ) async{
   final url = Uri.parse("${baseUrl}api/GetMerchantOrders?dateFilterType=$dateFilterType&startDate=$startDate&endDate=$endDate&Source=$source&subAgentId=$subAgentId");
