...
//       //             onChanged: (val) async {
//       //               setState(() {
//       //                 isActive = val; // Optimistic UI update
//       //               });
//       //
...
//       //
//       //               final result = await provider.getGroupStatus(widget.groupId); // pass your groupId here
//       //
//       //               result.match(
//       //                     (error) {
//       //                   // ❌ Handle error (rollback UI state if needed)
//       //                   setState(() {
//       //                     isActive = !val; // revert on failure
//       //                   });
//       //                   ScaffoldMessenger.of(context).showSnackBar(
...
//       //                 },
//       //                     (success) {
//       //                   // ✅ API success, update based on API response if needed
//       //                   setState(() {
//       //                     isActive = (success.currentStatus?.toLowerCase() == "active");
//       //                   });
//       //                 },
//       //               );
//       //             },
