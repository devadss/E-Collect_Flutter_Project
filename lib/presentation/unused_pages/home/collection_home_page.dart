...
//       agent.AgentCustomerDetailsModel(totalCount: 0, data: []);
...
//
//               accountNumber = customer.accNo.toString();
...
//                   child: Center(
//                     child: Text(
//                       "Today's Collection : Rs.${provider.collectionSummaryModel?.data?[0].totalCollected}",
//                       style: const TextStyle(
...
//               duesList?.data != null ? _buildCustomerInfo() : const SizedBox(),
//
//               const SizedBox(height: 15),
//               duesList?.data != null
//                   ? Expanded(
