...
//                             Spacer(flex: 1,),
//                             Text(item.name ?? "",style: TextStyle(color: home2, fontWeight: FontWeight.w700)),
//                           ],
//                         ),
//                         const Divider(),
//                         Row(
...
//                             Spacer(flex: 1,),
//                             Text(item.accNo ?? "", style: TextStyle(color: home2, fontWeight: FontWeight.w700),),
//                           ],
//                         ),
//
//                       ],
...
//
//                               padding: EdgeInsets.all(10),
//                               decoration: BoxDecoration(color: Colors.greenAccent.withAlpha(50), borderRadius: BorderRadius.circular(10)),
//                               child: Icon(Icons.credit_card, color: Colors.greenAccent,)),
//                           SizedBox(width: 5,),
...
//                               child: Icon(Icons.payments_outlined, color: Colors.orange,)),
//                           SizedBox(width: 5,),
...
//
//                               padding: EdgeInsets.all(10),
//                               decoration: BoxDecoration(color: Colors.redAccent.withAlpha(50), borderRadius: BorderRadius.circular(10)),
//                               child: Icon(Icons.payments_outlined, color: Colors.redAccent,)),
//                           SizedBox(width: 5,),
...
//
//                               padding: EdgeInsets.all(10),
//                               decoration: BoxDecoration(color: Colors.deepPurpleAccent.shade100.withAlpha(50), borderRadius: BorderRadius.circular(10)),
//                               child: Icon(Icons.payments_sharp, color: Colors.deepPurpleAccent,)),
//                           SizedBox(width: 5,),
//                           Text("Due Installment: \n${item.dueInstallments}"),
//                         ],),
//
//
//
