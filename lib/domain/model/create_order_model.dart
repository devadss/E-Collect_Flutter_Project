...
//
//     final paymentGatewayOrderResponseModel = paymentGatewayOrderResponseModelFromJson(jsonString);

import 'dart:convert';

PaymentGatewayOrderResponseModel paymentGatewayOrderResponseModelFromJson(String str) => PaymentGatewayOrderResponseModel.fromJson(json.decode(str));

String paymentGatewayOrderResponseModelToJson(PaymentGatewayOrderResponseModel data) => json.encode(data.toJson());

class PaymentGatewayOrderResponseModel {
  dynamic cartDetails;
  String? cfOrderId;
  DateTime? createdAt;
  ...
  PaymentGatewayOrderResponseModel({
    this.cartDetails,
    this.cfOrderId,
    this.createdAt,
  ...
  factory PaymentGatewayOrderResponseModel.fromJson(Map<String, dynamic> json) => PaymentGatewayOrderResponseModel(
